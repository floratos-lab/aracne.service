...
public interface AracneInputRepository {
    ...
    AracneOutput execute(String dataDir, int nboot, String mode, String algorithm) throws RemoteException;
    AracneConfig executeConfig(String dataDir, String algorithm) throws RemoteException;
